...
@section('content')
    ...
    <div id="overtime-success-message"
        class="fixed right-6 top-6 z-50 hidden rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-700 shadow-lg">
    </div>
    ...
    <div class="mt-6 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        ...
        <div class="border-b border-gray-200 px-4 py-4 sm:px-6 sm:py-5">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button type="button" id="open-overtime-modal"
        ...
        <div class="flex flex-col gap-3 border-b border-gray-200 bg-gray-50 px-4 py-4 sm:flex-row sm:items-end sm:px-6">
            ...
            <div class="relative flex-1">
                ...
                <div class="relative mt-2">
                    ...
                    <input type="text" id="overtime-search" placeholder="Search reason or date..."
            ...
            <div class="sm:w-52">
                ...
                <select id="overtime-status-filter"
        ...
        <div class="overflow-x-auto">
            ...
            <table class="w-full table-fixed divide-y divide-gray-200">
                ...
                <tbody id="overtime-table-body" class="divide-y divide-gray-200 bg-white"></tbody>
        ...
        <div id="no-filtered-overtime-records" class="hidden border-t border-gray-200 px-4 py-10 text-center">
        ...
        <div id="overtime-pagination" class="border-t border-gray-200 bg-white"></div>

    </div>


    <div id="overtime-request-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 px-4">
        ...
        <div class="w-full max-w-lg rounded-xl bg-white shadow-xl">
            ...
            <div class="flex items-start justify-between border-b border-gray-200 px-6 py-5">
                ...
                <button type="button" id="close-overtime-modal" class="text-gray-400 transition hover:text-gray-600">
            ...
            <form id="overtime-request-form" method="POST" action="{{ route('employee.overtime.store') }}">
                @csrf
                ...
                <div class="space-y-5 px-6 py-5">
                    ...
                    <div>
                        ...
                        <input type="date" id="overtime_date" name="date" required
                    ...
                    <div>
                        ...
                        <textarea id="overtime_reason" name="reason" rows="4" maxlength="500"
                ...
                <div class="flex justify-end gap-3 border-t border-gray-200 px-6 py-4">
                    ...
                    <button type="button" id="cancel-overtime-modal"
    ...
    <div id="overtime-details-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 px-4">
        ...
        <div class="w-full max-w-lg rounded-xl bg-white shadow-xl">
            ...
            <div class="flex items-start justify-between border-b border-gray-200 px-6 py-5">
                ...
                <button type="button" id="close-overtime-details-modal"
            ...
            <div class="space-y-5 px-6 py-5">
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p id="detail-overtime-date" class="mt-1 text-sm font-medium text-gray-900">
                            —
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p id="detail-overtime-hours" class="mt-1 text-sm font-medium text-gray-900">
                            —
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="detail-overtime-status" class="mt-1">
                            —
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p id="detail-overtime-submitted" class="mt-1 text-sm text-gray-900">
                            —
                        </p>
                    </div>
                ...
                <div id="detail-overtime-rejection-container" class="hidden">
                    ...
                    <div id="detail-overtime-rejection-reason"
            ...
            <div class="flex justify-end border-t border-gray-200 px-6 py-4">
                ...
                <button type="button" id="close-overtime-details-button"
                    class="rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50">
                    Close
                </button>
