...
<div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
    ...
    <div class="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2 lg:grid-cols-5 lg:items-center">
        ...
        <div class="flex justify-center lg:justify-end">
            @if ($attendanceStatus === 'not_started')
                <form method="POST" action="{{ route('employee.attendance.timeIn') }}" id="time-in-form" class="w-full lg:w-auto">
                    @csrf
            ...
            @elseif ($attendanceStatus === 'working')
                <form method="POST" action="{{ route('employee.attendance.timeOut') }}" id="time-out-form" class="w-full lg:w-auto">
                    @csrf
