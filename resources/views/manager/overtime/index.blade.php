    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        ...
        <div class="border-b border-gray-200 bg-gray-50 px-5 py-4">
            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div>
                    ...
                    <label for="manager-overtime-search" class="text-xs font-semibold uppercase tracking-wide text-gray-500">
                        Search
                    </label>

                    <input type="text" id="manager-overtime-search" placeholder="Search employee, reason..."
                ...
                <div>
                    ...
                    <label for="manager-overtime-status"
                        class="text-xs font-semibold uppercase tracking-wide text-gray-500">
                        Status
                    </label>

                    <select id="manager-overtime-status"
                        class="mt-2 w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-700 outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <label for="manager-overtime-date" class="text-xs font-semibold uppercase tracking-wide text-gray-500">
                        Date
                    </label>

                    <input type="date" id="manager-overtime-date"
                        class="mt-2 w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-700 outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
        ...
        <div class="hidden overflow-x-auto md:block">
            ...
            <table class="w-full table-fixed divide-y divide-gray-200">
                ...
                <tbody id="manager-overtime-table-body" class="divide-y divide-gray-200 bg-white"></tbody>
        ...
        <div id="manager-overtime-card-list" class="divide-y divide-gray-200 md:hidden"></div>


        <div id="manager-overtime-empty" class="hidden px-6 py-12 text-center">
        ...
        <div id="manager-overtime-pagination" class="border-t border-gray-200 bg-white"></div>

    </div>


    <div id="manager-overtime-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 px-4">
        ...
        <div class="w-full max-w-xl rounded-xl bg-white shadow-xl">
            ...
            <div class="flex items-start justify-between border-b border-gray-200 px-6 py-5">
                ...
                <button type="button" id="close-manager-overtime-modal"
            ...
            <div class="space-y-5 px-6 py-5">
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p id="review-overtime-employee" class="mt-1 text-sm font-semibold text-gray-900">
                            —
                        </p>
                    ...
                    <div>
                        ...
                        <p id="review-overtime-department" class="mt-1 text-sm text-gray-900">
                            —
                        </p>
                    ...
                    <div>
                        ...
                        <p id="review-overtime-position" class="mt-1 text-sm text-gray-900">
                            —
                        </p>
                    ...
                    <div>
                        ...
                        <p id="review-overtime-date" class="mt-1 text-sm text-gray-900">
                            —
                        </p>
                    ...
                    <div>
                        ...
                        <p id="review-overtime-hours" class="mt-1 text-sm font-medium text-gray-900">
                            —
                        </p>
                    ...
                    <div>
                        ...
                        <p id="review-overtime-submitted" class="mt-1 text-sm text-gray-900">
                            —
                        </p>
                    ...
                    <div>
                        ...
                        <div id="review-overtime-status" class="mt-1">
                            —
                        </div>
                ...
                <div id="manager-overtime-error"
                    class="hidden rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700"></div>


                <div id="overtime-reject-section" class="hidden">

                    <label for="overtime-rejection-reason"
                        class="text-xs font-semibold uppercase tracking-wide text-gray-500">
                        Rejection Reason
                    </label>

                    <textarea id="overtime-rejection-reason" rows="4" placeholder="Explain why this request is being rejected..."
            ...
            <div class="flex flex-col-reverse gap-2 border-t border-gray-200 px-6 py-4 sm:flex-row sm:justify-end">
                ...
                <button type="button" id="approve-overtime-btn"
