...
@section('content')
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <thead class="bg-gray-50">
                    ...
                    <tr>
                        ...
                        <th class="whitespace-nowrap px-3 py-3 text-center text-xs font-semibold uppercase tracking-wider text-gray-500">
                            User
                        </th>
            ...
            <div class="absolute left-1/2 top-1/2 w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-2xl bg-white shadow-2xl">
                ...
                <div class="grid grid-cols-1 gap-x-8 gap-y-6 px-6 pb-8 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <span class="mt-1.5 inline-flex items-center rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-sm font-medium text-gray-700">
                            {{ ucfirst($user->role) }}
                        </span>
        ...
        >
            ...
            <div class="absolute left-1/2 top-1/2 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white p-6 shadow-2xl">
                ...
                <form
                    ...
                    class="edit-user-form space-y-4"
                    method="POST"
                ...
                >
                    ...
                    <div class="flex flex-col-reverse gap-2 pt-2 sm:flex-row sm:justify-end">
                        ...
                        <button
                            type="submit"
                            class="w-full rounded-lg bg-[#11458c] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#1a3450] sm:w-auto"
                        >
                            Save Changes
                        </button>
    ...
    {{-- =====================================================
        DEACTIVATE USER MODALS
    ===================================================== --}}

    @foreach ($users as $user)

        <div
            id="deactivate-user-modal-{{ $user->id }}"
            class="fixed inset-0 z-50 hidden"
        >
    ...
    @foreach ($users as $user)
        ...
        <div
            id="activate-user-modal-{{ $user->id }}"
            class="fixed inset-0 z-50 hidden"
        >
            ...
            <div class="absolute left-1/2 top-1/2 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-xl bg-white p-4 shadow-2xl sm:p-6">
                ...
                <p
                    id="activate-user-error-{{ $user->id }}"
                    class="mb-4 hidden rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700"
                ></p>


                <form
                    id="activate-user-form-{{ $user->id }}"
                    class="activate-user-form"
                    method="POST"
