...
const viewEmployeeHireDate =
    document.getElementById(
        "view-employee-hire-date"
    )
...
function showViewEmployee(
    ...
    viewEmployeeManager.textContent =
        manager || "None"

    viewEmployeeHireDate.textContent =
        hireDate || "N/A"
